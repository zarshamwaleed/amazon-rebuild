...
import { ShoppingCart, Zap, Truck, ShieldCheck, Gift, Check } from 'lucide-react'
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
        ...
        <div className="md:col-span-3">
          <div className="border border-gray-300 rounded-lg p-4 space-y-3 lg:sticky lg:top-40">
            ...
            {addedToRegistry ? (
              <div className="text-xs text-green-700 bg-green-50 border border-green-200 rounded p-2 text-center flex items-center justify-center gap-1">
                <Check className="w-3.5 h-3.5" /> Added to your registry
              </div>
            ) : (
              <button
                onClick={() => setShowAddToRegistry(true)}
                className="w-full flex items-center justify-center gap-2 border border-gray-300 hover:bg-gray-50 py-2 rounded text-sm font-medium"
              >
